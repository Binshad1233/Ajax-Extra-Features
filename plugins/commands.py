...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('♻️ ʜᴇʟᴘ ♻️', msg.reply_photo("https://telegra.ph/file/9bd7c804fec2a2a278cfd.jpg'),
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        if message.command[1] != "subscribe":
            btn.append([InlineKeyboardButton("GROPL കേറി ഒന്നൂടെ REQUEST ചെയ്യുക", callback_data=f"checksub#{message.command[1]}")])
    ...
    if data.split("-", 1)[0] == "BATCH":
        sts = await message.reply("<b>സിനിമ വരുന്നുണ്ട്.../</b>")
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('join', url='https://t.me/cinimabucketv1') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
